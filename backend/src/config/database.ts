...
export const initDatabase = async () => {
  try {
    ...
    const topics = [
      ...
      'Биоэнергетика', 'Васту Шастра', 'Гвоздестояние, Садху', 'Гештальт-терапия', 'Гипнотерапия',
      'Дыхание: Нирхарана, Холотропное и др', 'Женские практики', 'Звукотерапия', 'Йога', 'Каббала',
      'Карты Ленорман', 'Квантовая психология', 'Кинезиология, PDTR-терапия', 'Космоэнергетика', 'МАК карты',
      ...
      'Расстановки, системные расстановки', 'Регрессивная терапия', 'Рефлексология', 'Рейки', 'Руны',
      'Сакральная Геометрия', 'Славянские практики', 'Соматические практики', 'Суфизм', 'Тайцзицюань',
      'Тантра', 'Таро', 'Телесно-ориентированная терапия', 'Тетахилинг', 'Трансперсональная Психология',
      'Традиционная Китайская Медицина', 'Фэн-шуй', 'Хиромантия', 'Хроники Акаши', 'Хьюман Дизайн',
